<?php /* Smarty version 2.6.27, created on 2013-10-16 11:31:09
         compiled from default%5Coffer/detail.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'default\\offer/detail.html', 27, false),array('modifier', 'nl2br', 'default\\offer/detail.html', 60, false),array('modifier', 'stripslashes', 'default\\offer/detail.html', 60, false),array('function', 'the_url', 'default\\offer/detail.html', 48, false),array('block', 'offer', 'default\\offer/detail.html', 107, false),)), $this); ?>
...
";
var url = "<?php echo $this->_tpl_vars['_G']['REQUEST_URI']; ?>
";
</script>
<?php echo '
<script>
...
"  class="btn_submit" id="favor" onclick="$('#FavorFrm').submit();" />
...
?>
		...
		<div class="detailtop3right">
			...
			<div class="contacttype">
				<p class="right1"><?php echo $this->_tpl_vars['_members_view']; ?>
</p>
...
logging.php?forward=<?php echo $this->_tpl_vars['_G']['REQUEST_URI']; ?>
...
member.php');"><?php echo $this->_tpl_vars['_registered_site_member']; ?>
			...
			<div class="contacttype">
				<h3><img src="<?php echo $this->_tpl_vars['theme_img_path']; ?>
images/lhighs.gif" /><?php echo $this->_tpl_vars['_contact']; ?>
</h3>
...
<?php echo $this->_tpl_vars['item']['site_url']; ?>
			...
			<div class="contacttype">
				<h3><img src="<?php echo $this->_tpl_vars['theme_img_path']; ?>
images/lhighs.gif" /><?php echo $this->_tpl_vars['_others']; ?>
...
<?php echo $this->_tpl_vars['item']['prim_imaccount']; ?>
			...
			<div class="contacttype">
				<h3><img src="<?php echo $this->_tpl_vars['theme_img_path']; ?>
images/lhighs.gif" /><?php echo $this->_tpl_vars['_add_information_release']; ?>
</h3>
				<ul>
...
</span><span class="type"><a target="_blank" href="index.php?do=offer&action=lists&typeid=<?php echo $this->_tpl_vars['item']['typeid']; ?>
