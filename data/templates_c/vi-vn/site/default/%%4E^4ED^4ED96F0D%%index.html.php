<?php /* Smarty version 2.6.27, created on 2013-10-30 13:57:58
         compiled from default%5Csearch/index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'sprintf', 'default\\search/index.html', 83, false),array('function', 'the_url', 'default\\search/index.html', 93, false),array('function', 'mailto', 'default\\search/index.html', 149, false),array('block', 'industry', 'default\\search/index.html', 129, false),array('block', 'area', 'default\\search/index.html', 135, false),array('block', 'userpage', 'default\\search/index.html', 144, false),)), $this); ?>
...
";
var select_item = "<?php echo $this->_tpl_vars['_G']['module']; ?>
";
var site_name = "<?php echo $this->_tpl_vars['_G']['site_name']; ?>
";
...
<input type="hidden" name="module" id="Module" value="<?php echo $this->_tpl_vars['module']; ?>
">
...
<span id="btn1" class="toocle2">&nbsp;<a href="javascript:;" title="<?php echo $this->_tpl_vars['_G']['site_name']; ?>
...
<div id="myurl0"><a href="index.php?do=topic&action=industry" target="_blank" class="anmyb2b"><?php echo $this->_tpl_vars['_industry_category']; ?>
</a></div>
</td>
<?php $this->_tag_stack[] = array('industry', array('level' => 1,'row' => 5)); $_block_repeat=true;smarty_block_industry($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <td class="index_4" width="75"><div id="myurl1"><a href="index.php?do=topic&action=industry&id=<?php echo $this->_tpl_vars['industry']['id']; ?>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_industry($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
    <td class="index_4"><div id="myurl7"><a href="index.php?do=topic&action=industry" class="an"><?php echo $this->_tpl_vars['_more']; ?>
&raquo;</a></div></td>
</tr>
  <tr><td class="index_4" height="22"><div id="myurl6"><a href="index.php?do=topic&action=area" target="_blank" class="anmyb2b"><?php echo $this->_tpl_vars['_area_category']; ?>
</a></div></td>
<?php $this->_tag_stack[] = array('area', array('level' => 1,'row' => 5)); $_block_repeat=true;smarty_block_area($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <td class="index_4"><div id="myurl7"><a href="index.php?do=topic&action=area&id=<?php echo $this->_tpl_vars['area']['id']; ?>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_area($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
    <td class="index_4"><div id="myurl7"><a href="index.php?do=topic&action=area" class="an"><?php echo $this->_tpl_vars['_more']; ?>
&raquo;</a></div></td>
</tr>
</tbody>
</table>  
