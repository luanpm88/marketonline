<?php /* Smarty version 2.6.27, created on 2014-08-21 14:53:12
...
" /><span class="shopname_right"><?php echo ((is_array($_tmp=$this->_tpl_vars['itemxxx']['title'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 32) : smarty_modifier_truncate($_tmp, 32)); ?>
			...
			<div class="rightbanner_block">
				...
				<a class="noresize" href="<?php echo smarty_function_the_url(array('module' => 'product','id' => ($this->_tpl_vars['itemxxx']['id']),'product_name' => ($this->_tpl_vars['itemxxx']['name'])), $this);?>
">
					<div class="img_box">
...
" />
				...
				<a class="title" style="border: none;margin-top: 10px;padding-top: 5px;border-top:solid 1px #ccc;" href="<?php echo smarty_function_the_url(array('module' => 'product','id' => ($this->_tpl_vars['itemxxx']['id']),'product_name' => ($this->_tpl_vars['itemxxx']['name'])), $this);?>
