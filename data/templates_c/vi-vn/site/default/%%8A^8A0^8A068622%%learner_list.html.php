<?php /* Smarty version 2.6.27, created on 2014-04-19 16:08:13
         compiled from default/studypost/learner_list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'the_url', 'default/studypost/learner_list.html', 54, false),array('function', 'pager', 'default/studypost/learner_list.html', 108, false),)), $this); ?>
...
?>
					...
					<div onclick="window.location='<?php echo smarty_function_the_url(array('module' => 'studypost','action' => 'memberpage','id' => ($this->_tpl_vars['item']['id'])), $this);?>
'">
					    <a class="head-title">
...
" />
 ...
 <?php echo $this->_tpl_vars['item']['last_name']; ?>
					    ...
					    <?php if ($this->_tpl_vars['item']['mobile']): ?><p><label>Điện thoại:</label> <?php echo $this->_tpl_vars['item']['mobile']; ?>
</p><?php endif; ?>
