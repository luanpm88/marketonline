<?php /* Smarty version 2.6.27, created on 2014-04-22 11:03:02
         compiled from default/studypost/group_list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'the_url', 'default/studypost/group_list.html', 55, false),array('function', 'pager', 'default/studypost/group_list.html', 105, false),array('modifier', 'truncate', 'default/studypost/group_list.html', 69, false),)), $this); ?>
...
?>
					...
					<div onclick="window.location='<?php echo smarty_function_the_url(array('module' => 'studypost','action' => 'group','id' => ($this->_tpl_vars['item']['id'])), $this);?>
'">
					    <a class="head-title">
...
" />
					...
					<div class="action">					    
							...
							<a href="<?php echo smarty_function_the_url(array('module' => 'studypost','action' => 'group','id' => ($this->_tpl_vars['item']['id'])), $this);?>
">
							    Chờ duyệt
							</a>
						    <?php else: ?>
