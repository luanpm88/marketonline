...
?>
					...
					<div onclick="window.location='<?php echo smarty_function_the_url(array('module' => 'studypost','action' => 'group','id' => ($this->_tpl_vars['item']['id']),'title' => ($this->_tpl_vars['item']['subject_name'])), $this);?>
'">
					    <a class="head-title">
...
" />
						...
						<span><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['school_name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 40) : smarty_modifier_truncate($_tmp, 40)); ?>
</span>
					    </a>
					    <?php if ($this->_tpl_vars['item']['address']): ?><p><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['address'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 40) : smarty_modifier_truncate($_tmp, 40)); ?>
</p><?php endif; ?>
					...
					<div class="action">					    
                                                <?php if ($this->_tpl_vars['item']['joined']): ?>
						    <?php if (! $this->_tpl_vars['item']['status']): ?>
							<a href="<?php echo smarty_function_the_url(array('module' => 'studypost','action' => 'group','id' => ($this->_tpl_vars['item']['id']),'title' => ($this->_tpl_vars['item']['subject_name'])), $this);?>
">
							    Chờ duyệt
							</a>
						    <?php else: ?>
...
">
						...
						<?php else: ?>
						    <?php if (! $this->_tpl_vars['item']['status']): ?>
							<a class="join_group" onclick="window.location='<?php echo smarty_function_the_url(array('module' => 'studypost','action' => 'join_group','id' => ($this->_tpl_vars['item']['id'])), $this);?>
'">
							    Tham gia
							</a>
						    <?php else: ?>
