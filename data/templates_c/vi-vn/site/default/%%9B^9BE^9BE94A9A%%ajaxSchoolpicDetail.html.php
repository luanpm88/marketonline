<?php /* Smarty version 2.6.27, created on 2014-03-25 16:23:27
         compiled from default/studypost/ajaxSchoolpicDetail.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'the_url', 'default/studypost/ajaxSchoolpicDetail.html', 12, false),array('function', 'formhash', 'default/studypost/ajaxSchoolpicDetail.html', 78, false),)), $this); ?>
...
?>
					    <img del-url="<?php echo smarty_function_the_url(array('module' => 'studypost','action' => 'del_schoolbanner','id' => ($this->_tpl_vars['item']['id'])), $this);?>
...
" />
					...
					<h2><a href="<?php echo smarty_function_the_url(array('module' => 'studypost','action' => 'school','id' => ($this->_tpl_vars['school']['id'])), $this);?>
"><?php echo $this->_tpl_vars['school']['name']; ?>
</a></h2>
					
					<?php if ($this->_tpl_vars['school']['address']): ?><p><label>Địa chỉ </label><label class="two_points">:</label> <?php echo $this->_tpl_vars['school']['address']; ?>
</p><?php endif; ?>
					<?php if ($this->_tpl_vars['school']['phone']): ?><p><label>Điện thoại </label><label class="two_points">:</label> <?php echo $this->_tpl_vars['school']['phone']; ?>
</p><?php endif; ?>
					<?php if ($this->_tpl_vars['school']['email']): ?><p><label>Email </label><label class="two_points">:</label> <a href="mailto:<?php echo $this->_tpl_vars['school']['email']; ?>
"><?php echo $this->_tpl_vars['school']['email']; ?>
</a></p><?php endif; ?>
					<?php if ($this->_tpl_vars['school']['website']): ?><p><label>Website </label><label class="two_points">:</label> <a href="<?php echo $this->_tpl_vars['school']['website']; ?>
"><?php echo $this->_tpl_vars['school']['website']; ?>
</a></p><?php endif; ?>
...
">					
						...
						<div class="pic_description_form">
						    <form class="picdes fhide" action="<?php echo smarty_function_the_url(array('module' => 'studypost','action' => 'postSchoolpicDescription'), $this);?>
" method="post">
 ...
 (<span class="comment_count"><?php echo $this->_tpl_vars['item']['comments']['count']; ?>
						    ...
						    <div class="comments-box">
							    ...
							    <?php if ($this->_tpl_vars['pb_username'] != ""): ?>
								    <form name="productaddfrm" class="productaddfrm" id="Frm1" method="post" action="<?php echo smarty_function_the_url(array('module' => 'studypost','action' => 'postSchoolpicComment'), $this);?>
