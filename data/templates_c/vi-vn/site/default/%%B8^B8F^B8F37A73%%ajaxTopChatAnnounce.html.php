<?php /* Smarty version 2.6.27, created on 2014-08-13 15:48:30
	...
	<div class="announce_title">Tin nhắn</div>
        <ul>
            <?php if (! $this->_tpl_vars['Items']): ?>
                <li style="text-align: center" class="no_sms"><?php echo $this->_tpl_vars['_no_message']; ?>
</li>
            <?php else: ?>
...
?>
		    <?php if (! $this->_tpl_vars['item']['hide'] || true): ?>
...
" />
		...
		<?php if ($this->_tpl_vars['Items_count'] > $this->_tpl_vars['CHAT_ANNOUNCE_COUNT']): ?><li class="loading">...</li><?php endif; ?>
	    <?php endif; ?>
        </ul>
