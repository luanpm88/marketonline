...
?>
						<li class="level1">
							<a class="level1" href="<?php echo smarty_function_the_url(array('module' => ($this->_tpl_vars['module']),'level' => 2,'industryid' => ($this->_tpl_vars['level1']['id']),'title' => ($this->_tpl_vars['level1']['name'])), $this);?>
