<?php /* Smarty version 2.6.27, created on 2013-05-21 09:26:49
         compiled from dict.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'pl', 'dict.html', 41, false),array('modifier', 'truncate_multi', 'dict.html', 44, false),array('function', 'the_url', 'dict.html', 48, false),)), $this); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['word'])) ? $this->_run_mod_handler('pl', true, $_tmp) : smarty_modifier_pl($_tmp)); ?>
</label></td>
		  <td><?php echo $this->_tpl_vars['item']['word_name']; ?>
</td>
		  <td><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['typename'])) ? $this->_run_mod_handler('pl', true, $_tmp) : smarty_modifier_pl($_tmp)); ?>
</td>
		  <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['digest'])) ? $this->_run_mod_handler('pl', true, $_tmp) : smarty_modifier_pl($_tmp)))) ? $this->_run_mod_handler('truncate_multi', true, $_tmp, 50) : smarty_modifier_truncate_multi($_tmp, 50)); ?>
</td>
		  <td class="handler">
          <ul id="handler_icon">
...
"><?php echo $this->_tpl_vars['_delete']; ?>
            ...
            <li><a class="btn_browse"  href="<?php echo smarty_function_the_url(array('module' => 'dict','id' => $this->_tpl_vars['item']['id']), $this);?>
