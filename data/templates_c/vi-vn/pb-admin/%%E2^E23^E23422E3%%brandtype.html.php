<?php /* Smarty version 2.6.27, created on 2013-05-21 09:13:36
         compiled from brandtype.html */ ?>
...
<?php echo $this->_tpl_vars['_sorts']; ?>
        ...
        <li><a class="btn1" href="brandtype.php"><span><?php echo $this->_tpl_vars['_brands']; ?>
<?php echo $this->_tpl_vars['_sorts']; ?>
</span></a></li>
        <li><a href="brandtype.php?do=edit"><?php echo $this->_tpl_vars['_add_or_edit']; ?>
</a></li>
    </ul>
</div>
<div class="mrightTop"> 
...
<div class="tdare">
  <form name="list_frm" id="ListFrm" action="brandtype.php" method="post">
...
"><?php echo $this->_tpl_vars['item']['name']; ?>
		  ...
		  <td class="handler">
           <ul id="handler_icon">
            <li><a class="btn_delete" href="brandtype.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&do=del<?php echo $this->_tpl_vars['addParams']; ?>
" title="<?php echo $this->_tpl_vars['_delete']; ?>
"><?php echo $this->_tpl_vars['_delete']; ?>
</a></li>
            <li><a class="btn_edit" href="brandtype.php?do=edit&id=<?php echo $this->_tpl_vars['item']['id']; ?>
