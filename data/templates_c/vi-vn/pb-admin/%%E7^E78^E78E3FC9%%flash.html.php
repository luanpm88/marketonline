<?php /* Smarty version 2.6.27, created on 2014-08-14 10:41:22
...
h1 {font-size: 12px; color: #444; line-height: 55px; background: url(../templates/admin/images/welcome_h1.gif); padding-left: 2%}
...
<dl style="background: url(<?php echo $this->_tpl_vars['admin_theme_path']; ?>
images/<?php echo $this->_tpl_vars['action_img']; ?>
) no-repeat left 10px; ">
