<?php /* Smarty version 2.6.27, created on 2013-11-18 13:41:35
         compiled from industry.edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'industry.edit.html', 86, false),array('modifier', 'default', 'industry.edit.html', 86, false),)), $this); ?>
...
<div class="info">
  <form method="post" enctype="multipart/form-data" action="industry.php" id="EditFrm" name="edit_frm">
...
<?php echo $this->_tpl_vars['_colon']; ?>
      ...
      <tr>
        <th class="paddingT15"> Share Facebook</th>
        <td class="paddingT15 wordSpacing5"><?php echo smarty_function_html_radios(array('name' => "data[industry][share_facebook]",'options' => $this->_tpl_vars['AskAction'],'checked' => ((is_array($_tmp=@$this->_tpl_vars['item']['share_facebook'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0)),'separator' => ""), $this);?>
</td>
      </tr>
      <tr>
