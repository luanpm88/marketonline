<?php /* Smarty version 2.6.27, created on 2013-05-21 09:27:15
         compiled from quotetype.html */ ?>
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
		<li><a href="market.php"><?php echo $this->_tpl_vars['_management']; ?>
</a></li>
		<li><a href="quote.php"><?php echo $this->_tpl_vars['_price_quotes']; ?>
</a></li>
        <li><a class="btn1" href="quotetype.php"><span><?php echo $this->_tpl_vars['_quotes']; ?>
<?php echo $this->_tpl_vars['_sorts']; ?>
</span></a></li>
        <li><a href="quotetype.php?do=edit"><?php echo $this->_tpl_vars['_add_or_edit']; ?>
</a></li>
    </ul>
</div>
<div class="mrightTop"> 
...
<div class="tdare">
  <form name="list_frm" id="ListFrm" action="quotetype.php" method="post">
...
"><?php echo $this->_tpl_vars['item']['name']; ?>
		  ...
		  <td class="handler">
           <ul id="handler_icon">
            <li><a class="btn_delete" href="quotetype.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&do=del<?php echo $this->_tpl_vars['addParams']; ?>
" title="<?php echo $this->_tpl_vars['_delete']; ?>
"><?php echo $this->_tpl_vars['_delete']; ?>
</a></li>
            <li><a class="btn_edit" href="quotetype.php?do=edit&id=<?php echo $this->_tpl_vars['item']['id']; ?>
