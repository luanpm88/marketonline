<?php /* Smarty version 2.6.27, created on 2014-08-14 11:57:12
         compiled from adzone.edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'adzone.edit.html', 102, false),)), $this); ?>
...
<?php echo $this->_tpl_vars['_colon']; ?>
      ...
      <tr>
        <th class="paddingT15">For Company Zone</th>
        <td class="paddingT15 wordSpacing5">
		<label for="Sourcetype1">
			<input <?php if ($this->_tpl_vars['item']['company_zone']): ?>checked="checked"<?php endif; ?> type="radio" name="adzone[company_zone]" id="Sourcetype1" value="1"/>
			Yes
		</label>
		<label for="Sourcetype2">
			<input <?php if (! $this->_tpl_vars['item']['company_zone']): ?>checked="checked"<?php endif; ?> type="radio" name="adzone[company_zone]" id="Sourcetype2" value="0"/>
			No
		</label>
          </td>
      </tr>
