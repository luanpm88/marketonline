<?php /* Smarty version 2.6.27, created on 2013-05-21 09:13:30
         compiled from productcategory.html */ ?>
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
        ...
        <li><a class="btn1" href="productcategory.php"><span><?php echo $this->_tpl_vars['_product']; ?>
<?php echo $this->_tpl_vars['_sorts']; ?>
</span></a></li>
        <li><a href="productcategory.php?do=edit"><?php echo $this->_tpl_vars['_add_or_edit']; ?>
</a></li>
...
<div class="tdare">
  <form name="list_frm" id="ListFrm" action="productcategory.php" method="post">
...
"><?php echo $this->_tpl_vars['item']['name']; ?>
		  ...
		  <td class="handler">
           <ul id="handler_icon">
            <li><a class="btn_delete" href="productcategory.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&do=del<?php echo $this->_tpl_vars['addParams']; ?>
" title="<?php echo $this->_tpl_vars['_delete']; ?>
"><?php echo $this->_tpl_vars['_delete']; ?>
</a></li>
            <li><a class="btn_edit" href="productcategory.php?do=edit&id=<?php echo $this->_tpl_vars['item']['id']; ?>
