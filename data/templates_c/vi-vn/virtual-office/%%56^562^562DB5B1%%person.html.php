<?php /* Smarty version 2.6.27, created on 2014-07-07 10:16:43
         compiled from person.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'person.html', 9, false),array('function', 'editor', 'person.html', 17, false),array('function', 'formhash', 'person.html', 272, false),array('function', 'html_radios', 'person.html', 398, false),)), $this); ?>
...
<?php endif; ?><?php echo '
	...
	function inserEditorFile(url, image) {
		...
		if (image) {
			tinyMCE.activeEditor.execCommand(\'mceFocus\',false,\'company_des\');
...
<font class="red">*</font></th>
								<td class="circle_right"><input placeholder="Tên Shop Cá Nhân hoặc lấy Tên Công Ty / Tên Nhà Phân Phối" type="text" name="data[company][name]" id="dataCompanyName" value="<?php echo $this->_tpl_vars['item']['name']; ?>
...
" size="30" class="required"></td>
		...
		<h3><?php echo $this->_tpl_vars['_person_company_contact']; ?>
</h3>
...
" style="width:432px;"></td>
		...
		<h3><?php echo $this->_tpl_vars['_sectors']; ?>
</h3>
			<span class="top-table">.</span>
				<table class="offer_info_content">
					<tr>
							<th> <?php echo $this->_tpl_vars['_select_sectors']; ?>
</td>
							<td>
...
"><?php echo $this->_tpl_vars['itemc']['name']; ?>
		...
		<h3><?php echo $this->_tpl_vars['_thungo_shop']; ?>
</h3>
		 <p>
...
<div style="display: none">
	<h3>B. <?php echo $this->_tpl_vars['_company_power']; ?>
</h3>
		<span class="top-table">.</span>
		<table class="offer_info_content">
...
">
	       ...
	       <tr>
                <th><?php echo $this->_tpl_vars['_company_boss_man']; ?>
</th>
                <td><font color="#666666"> <span class="zi">
...
" size="32">
		...
		<input name="data[company][bank_from]" type="text" id="bank_from" value="<?php echo $this->_tpl_vars['item']['bank_from']; ?>
" size="32">
		</td>
              </tr>
	      <tr>
