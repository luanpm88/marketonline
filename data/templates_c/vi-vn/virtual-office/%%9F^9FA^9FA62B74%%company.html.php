<?php /* Smarty version 2.6.27, created on 2014-02-12 08:22:09
...
images/offer_01.gif" /></div>
     <div class="offer_info_title"><h2><?php echo $this->_tpl_vars['_company_info']; ?>
</h2></div>
...
<font class="red">*</font></th>
								<td class="circle_right"><input placeholder="Tên Công Ty / Tên Nhà Phân Phối" type="text" name="data[company][name]" id="dataCompanyName" value="<?php echo $this->_tpl_vars['item']['name']; ?>
...
" size="30" class="required"></td>
		...
		<br />
		<h2><?php echo $this->_tpl_vars['_company_intro']; ?>
</h2>
...
" /></div><?php endif; ?></td>
		...
		<h3>C. <?php echo $this->_tpl_vars['_thungo_company']; ?>
