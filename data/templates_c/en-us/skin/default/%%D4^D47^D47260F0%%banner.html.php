<?php /* Smarty version 2.6.27, created on 2013-06-03 06:50:08
         compiled from banner.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'banner.html', 32, false),array('function', 'formhash', 'banner.html', 50, false),)), $this); ?>
	<script language="javascript" src="<?php echo $this->_tpl_vars['WebRootUrl']; ?>
scripts/jquery/jquery.form.js"></script>
	<link href="<?php echo $this->_tpl_vars['WebRootUrl']; ?>
scripts/jquery/smoothConfirm/smoothConfirm.css" media="screen" rel="stylesheet" type="text/css" />
	<script src="<?php echo $this->_tpl_vars['WebRootUrl']; ?>
scripts/jquery/smoothConfirm/jquery.smoothConfirm.js" type="text/javascript"></script>
	<script>
	var ok_btn = "<?php echo $this->_tpl_vars['_sure']; ?>
";
	var cancel_btn = "<?php echo $this->_tpl_vars['_cancel']; ?>
";
	</script>
	<?php echo '
	...
	<div class="head">
		<ul class="list1">
			<li class="company"><a id="AddToFriend" href="javascript:;" title="<?php echo $this->_tpl_vars['_add_friend']; ?>
"><?php echo $this->_tpl_vars['_add_friend']; ?>
</a></li>
