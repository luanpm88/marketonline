<?php /* Smarty version 2.6.27, created on 2013-06-27 23:48:49
         compiled from product.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'product', 'product.html', 37, false),array('function', 'the_url', 'product.html', 44, false),array('function', 'pager', 'product.html', 71, false),array('modifier', 'truncate', 'product.html', 47, false),)), $this); ?>
...
<?php endif; ?></h3>
			...
			<ul class="products">
				...
				<?php $this->_tag_stack[] = array('product', array('name' => 'item','companyid' => ($this->_tpl_vars['COMPANY']['id']),'industryid' => ($this->_tpl_vars['aaa']),'row' => 20)); $_block_repeat=true;smarty_block_product($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
