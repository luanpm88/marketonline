<?php /* Smarty version 2.6.27, created on 2013-06-21 10:53:24
         compiled from company.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'company.html', 9, false),array('function', 'editor', 'company.html', 40, false),array('function', 'formhash', 'company.html', 68, false),array('function', 'html_checkboxes', 'company.html', 178, false),)), $this); ?>
...
<div class="steps">
	<div>
	    <h2><a href="personal.php"><?php echo $this->_tpl_vars['_complete_pro_date']; ?>
<?php if ($this->_tpl_vars['hasProfile']): ?> <img style="margin-left: 10px;position: absolute;" src="../templates/office/images/published.png" /><?php endif; ?></a></h2>
	</div>
	<div>
	    <h2><a class="active" href="company.php"><?php echo $this->_tpl_vars['_added_comany_info']; ?>
<?php if ($this->_tpl_vars['hasCompany']): ?> <img style="margin-left: 10px;position: absolute;" src="../templates/office/images/published.png" /><?php endif; ?></a></h2>
	</div>
    </div>
...
">        
		 ...
		 <input type="hidden" name="do" id="Do" value="save" />
          <table class="offer_info_content">
              <tr>
                <th class="circle_left"><?php echo $this->_tpl_vars['_company_name_n']; ?>
...
" size="32" class="required"></td>
              ...
              <tr>
                ...
                <td>
			<div><input style="margin-bottom: 5px;" name="pic" type="file" id="Picture" size="32" onchange="document.getElementById('CompanyLogo').innerHTML='<img src=\''+this.value+'\' width=117 height=63>'"></div>
			<div id="CompanyLogo" style="display: table-cell;height: 97px;margin-top: 5px;vertical-align: middle;width: 117px;border: solid 1px #AAA"><?php if ($this->_tpl_vars['item']['logo']): ?><img style="margin-bottom: 0" src="<?php echo $this->_tpl_vars['item']['logo']; ?>
" width="117" alt="<?php echo $this->_tpl_vars['_logo_image']; ?>
" /><?php endif; ?></div></td>
              </tr>
...
" /></div><?php endif; ?></td>
              ...
              <tr>
               ...
               <td class="circle_bottomright"><input name="company_edit" type="submit" id="CompanyEdit" value="<?php echo $this->_tpl_vars['_confirm_submit']; ?>
"></td>
              </tr>
          </table>
	</form>
