...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'index.html', 6, false),array('modifier', 'pl', 'index.html', 36, false),array('block', 'announce', 'index.html', 67, false),)), $this); ?>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['group']['name'])) ? $this->_run_mod_handler('pl', true, $_tmp) : smarty_modifier_pl($_tmp)); ?>
</td>
           ...
           <div class="notice">
              ...
              <ul>
				<?php $this->_tag_stack[] = array('announce', array('row' => 10)); $_block_repeat=true;smarty_block_announce($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
					<li><a href="<?php echo $this->_tpl_vars['announce']['url']; ?>
