<?php /* Smarty version 2.6.27, created on 2013-05-22 09:01:10
...
"><input type="text" name="name[]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['name'])) ? $this->_run_mod_handler('pl', true, $_tmp) : smarty_modifier_pl($_tmp)); ?>
" id="dataMembergroupName<?php echo $this->_tpl_vars['item']['id']; ?>
" /></label></td>
		  <td><?php if ($this->_tpl_vars['item']['is_default'] == 1): ?><img src="<?php echo $this->_tpl_vars['admin_theme_path']; ?>
images/right.gif" /><?php endif; ?></td>
