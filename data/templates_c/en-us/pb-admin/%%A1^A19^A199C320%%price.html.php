<?php /* Smarty version 2.6.27, created on 2013-05-14 01:40:46
         compiled from price.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'pl', 'price.html', 45, false),)), $this); ?>
...
<?php echo $this->_tpl_vars['_sorts']; ?>
        ...
        <li><a class="btn1" href="price.php"><span><?php echo $this->_tpl_vars['_prices']; ?>
</span></a></li>
        <li><a href="price.php?do=edit"><?php echo $this->_tpl_vars['_add_or_edit']; ?>
</a></li>
    </ul>
</div>
<div class="mrightTop"> 
...
<div class="tdare">
  <form name="list_frm" id="ListFrm" action="price.php" method="post">
...
/<?php echo $this->_tpl_vars['Measuries'][$this->_tpl_vars['item']['units']]; ?>
		  ...
		  <td class="handler">
           <ul id="handler_icon">
            <li><a class="btn_delete" href="price.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&do=del<?php echo $this->_tpl_vars['addParams']; ?>
" title="<?php echo $this->_tpl_vars['_delete']; ?>
"><?php echo $this->_tpl_vars['_delete']; ?>
</a></li>
            <li><a class="btn_edit" href="price.php?do=edit&id=<?php echo $this->_tpl_vars['item']['id']; ?>
