<?php /* Smarty version 2.6.27, created on 2013-05-02 06:40:12
...
<div class="info">
 ...
 <?php echo $this->_tpl_vars['_naming_n']; ?>
        ...
        <td class="paddingT15 wordSpacing5"><input name="data[setting][site_name]" type="text" id="site_name" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['item']['SITE_NAME'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['_G']['site_name']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['_G']['site_name'])); ?>
...
<?php echo $this->_tpl_vars['_colon']; ?>
        ...
        <td class="paddingT15 wordSpacing5"><input name="data[setting][site_title]" type="text" id="site_title" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['item']['SITE_TITLE'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['_G']['site_title']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['_G']['site_title'])); ?>
" class="infoTableInput" />
...
"/>
      ...
      <tr>
        ...
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput" name="data[setting][site_logo]" type="text" id="site_logo" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['item']['SITE_LOGO'])) ? $this->_run_mod_handler('default', true, $_tmp, ($this->_tpl_vars['admin_theme_path'])."images/logo.gif") : smarty_modifier_default($_tmp, ($this->_tpl_vars['admin_theme_path'])."images/logo.gif")); ?>
"/>
