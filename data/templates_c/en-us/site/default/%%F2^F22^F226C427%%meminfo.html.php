<?php /* Smarty version 2.6.27, created on 2013-05-31 04:57:48
         compiled from default%5Cproduct/meminfo.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'default\\product/meminfo.html', 375, false),)), $this); ?>
...
<div class="row">
    <div class="fifteen columns" id="page-title">
        ...
        <h1 class="page-title">
                        <?php echo $this->_tpl_vars['_buy_info']; ?>
                    </h1>
...
"><?php echo $this->_tpl_vars['_home_page']; ?>
    ...
    <div class="detailtopcon clearfix">
		<h3><?php echo $this->_tpl_vars['_customer_info']; ?>
</h3>
	...
	<div class="checkInfor">
                        <!--<h2>Thông tin người mua</h2>   -->
                <p><?php echo $this->_tpl_vars['_member_info_announce']; ?>
</p>
...
<b class="red-bold">*</b>&nbsp;</span>
			<input type="text" maxlength="11" id="fullname" name="data[order][fullname]" class="bgWhite" value="<?php echo $this->_tpl_vars['pb_userinfo']['fullname']; ?>
...
" <?php if ($this->_tpl_vars['pb_userinfo']['address']): ?> readonly="readonly" <?php endif; ?> maxlength="120" name="data[order][address]" id="address" class="bgWhite" />
                  ...
                  <!--<div class="warningProduct check-war">
                            <p class="clearfix">Nếu đã có tài khoản, hãy <a href="javascript:void(0)" class="other show-list" rel="login-popup" onclick="_gaq.push(['_trackEvent','Checkout','Login', 'Login']);">đăng nhập</a>
                            </p>
                        </div>-->
...
" <?php if ($this->_tpl_vars['pb_userinfo']['receiver_address']): ?> disabled="disabled" <?php endif; ?> maxlength="120" name="data[order][receiver_address]" id="receiver_address" class="bgWhite" />
            ...
            <div class="messforSell">
                <span style="width:130px;float:left;margin-top:5px"><?php echo $this->_tpl_vars['_message_for_buyer']; ?>
</span>
		<textarea id="message" type="text" name="data[order][message]" value="" style="height:100px;width:1030px" class="bgInput"></textarea>
            </div>
