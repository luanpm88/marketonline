<?php /* Smarty version 2.6.27, created on 2013-05-27 04:40:33
...
<div class="row">
    ...
    <div class="four columns" style="margin-left: 80px">
	  ...
	  <div class="widget-inner">
	    <h3><?php echo $this->_tpl_vars['_info']; ?>
</h3>
...
<div class="wrapper">
    <div class="content">
        ...
        <form name="loggingfrm" id="LoggingFrm" method="post" action="cartlogging.php" autocomplete="off">
...
/localez.js" charset="<?php echo $this->_tpl_vars['charset']; ?>
"></script>
<script language="javascript" src="scripts/jquery/jquery.validatez.js"></script>
<script language="javascript" src="scripts/validatez.js" charset="<?php echo $this->_tpl_vars['charset']; ?>
"></script>
<script>
