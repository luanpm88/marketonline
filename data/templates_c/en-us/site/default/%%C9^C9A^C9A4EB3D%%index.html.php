<?php /* Smarty version 2.6.27, created on 2013-05-21 07:54:23
         compiled from default%5Coffer/index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ads', 'default\\offer/index.html', 4, false),array('block', 'offer', 'default\\offer/index.html', 19, false),array('block', 'company', 'default\\offer/index.html', 80, false),array('block', 'product', 'default\\offer/index.html', 94, false),array('modifier', 'date_format', 'default\\offer/index.html', 16, false),array('function', 'get', 'default\\offer/index.html', 107, false),array('function', 'the_url', 'default\\offer/index.html', 109, false),)), $this); ?>
...
?>
                <h3 class="cb"><em class="fl"><a href="<?php echo smarty_function_the_url(array('module' => 'search','industryid' => ($this->_tpl_vars['item0']['id']),'do' => 'offer','action' => 'lists'), $this);?>
"><?php echo $this->_tpl_vars['item0']['name']; ?>
</a></em><p class="fr"><a href="index.php?do=offer&action=lists&industryid=<?php echo $this->_tpl_vars['item0']['id']; ?>
...
?>
                <div class="fl">
                    <a href="<?php echo smarty_function_the_url(array('module' => 'search','industryid' => ($this->_tpl_vars['level1']['id']),'do' => 'offer','action' => 'lists'), $this);?>
...
?>
                    <a href="<?php echo smarty_function_the_url(array('module' => 'search','industryid' => ($this->_tpl_vars['level2']['id']),'do' => 'offer','action' => 'lists'), $this);?>
