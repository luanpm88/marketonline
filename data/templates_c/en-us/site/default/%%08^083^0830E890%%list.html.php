<?php /* Smarty version 2.6.27, created on 2013-05-14 06:21:54
         compiled from default%5Csearch/list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'sprintf', 'default\\search/list.html', 30, false),array('modifier', 'urldecode', 'default\\search/list.html', 51, false),array('modifier', 'pl', 'default\\search/list.html', 105, false),array('modifier', 'truncate_multi', 'default\\search/list.html', 106, false),array('function', 'the_url', 'default\\search/list.html', 46, false),array('function', 'pager', 'default\\search/list.html', 168, false),array('function', 'mailto', 'default\\search/list.html', 209, false),array('block', 'industry', 'default\\search/list.html', 85, false),array('block', 'company', 'default\\search/list.html', 103, false),array('block', 'adword', 'default\\search/list.html', 121, false),array('block', 'userpage', 'default\\search/list.html', 204, false),)), $this); ?>
...
<table height="70" cellspacing="0" cellpadding="0" border="0">
  <form name="search_frm" method="get" action="<?php echo $this->_tpl_vars['_G']['PHP_SELF']; ?>
">
  <tbody>
  <tr>
...
?>
			<?php if ($this->_tpl_vars['key'] == $this->_tpl_vars['_G']['module']): ?>
			<strong><?php echo $this->_tpl_vars['module']; ?>
</strong>&nbsp;&nbsp;&nbsp;&nbsp;
			<?php else: ?>
			<a href="<?php echo smarty_function_the_url(array('module' => 'list','extra' => "module,".($this->_tpl_vars['key'])."|typeid|pos|total_count"), $this);?>
"><?php echo $this->_tpl_vars['module']; ?>
        ...
        <tr>
          <td nowrap><input value="<?php echo ((is_array($_tmp=$this->_tpl_vars['_G']['q'])) ? $this->_run_mod_handler('urldecode', true, $_tmp) : urldecode($_tmp)); ?>
" name="q" id="kw" size="42" maxlength="90"> 
...
" class="q" style="<?php if ($this->_tpl_vars['_G']['typeid'] == $this->_tpl_vars['key1']): ?>font-weight:bold;<?php endif; ?>"><?php echo $this->_tpl_vars['item1']; ?>
</a></div>
		<?php endforeach; endif; unset($_from); ?>
	</div>
	<?php else: ?>
...
<a title="" href="<?php echo smarty_function_the_url(array('module' => 'list','extra' => "do,".($this->_tpl_vars['_G']['do'])."|orderby,dateline"), $this);?>
  ...
  <tr>
    <td class="std">
      <ol id="ad_r">
        ...
        <h3><a title="<?php echo ((is_array($_tmp=$this->_tpl_vars['company']['name'])) ? $this->_run_mod_handler('pl', true, $_tmp) : smarty_modifier_pl($_tmp)); ?>
" target="_blank" href="<?php echo $this->_tpl_vars['company']['url']; ?>
" id="an1"><?php echo ((is_array($_tmp=$this->_tpl_vars['company']['name'])) ? $this->_run_mod_handler('pl', true, $_tmp) : smarty_modifier_pl($_tmp)); ?>
</a></h3>
		<?php if ($this->_tpl_vars['company']['main_prod']): ?><?php echo $this->_tpl_vars['_main_business']; ?>
...
?>
  <li class="g">  
  <h3 class="r"><font color="#261cdc"><?php if ($this->_tpl_vars['item']['typename']): ?>[<?php echo $this->_tpl_vars['item']['typename']; ?>
]<?php endif; ?></font>&nbsp;<a title="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['title'])) ? $this->_run_mod_handler('pl', true, $_tmp) : smarty_modifier_pl($_tmp)); ?>
" target="_blank" href="<?php echo $this->_tpl_vars['item']['url']; ?>
" class="l"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['title'])) ? $this->_run_mod_handler('pl', true, $_tmp) : smarty_modifier_pl($_tmp)))) ? $this->_run_mod_handler('truncate_multi', true, $_tmp, 20) : smarty_modifier_truncate_multi($_tmp, 20)); ?>
...
"></a>
  ...
  <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['digest'])) ? $this->_run_mod_handler('pl', true, $_tmp) : smarty_modifier_pl($_tmp)))) ? $this->_run_mod_handler('truncate_multi', true, $_tmp, 100) : smarty_modifier_truncate_multi($_tmp, 100)); ?>
<br>
  <cite>
  <?php if ($this->_tpl_vars['item']['extra']): ?><?php echo $this->_tpl_vars['item']['extra']; ?>
<?php else: ?><?php echo $this->_tpl_vars['item']['url']; ?>
<?php endif; ?>
  <?php if ($this->_tpl_vars['item']['pubdate']): ?>- (<?php echo $this->_tpl_vars['item']['pubdate']; ?>
)<?php endif; ?>
  </cite>
...
<form name="f1" action="<?php echo $this->_tpl_vars['_G']['PHP_SELF']; ?>
"><span style="margin-bottom: 7px; height: 22px;">
<input value="<?php echo ((is_array($_tmp=$this->_tpl_vars['_G']['q'])) ? $this->_run_mod_handler('urldecode', true, $_tmp) : urldecode($_tmp)); ?>
" name="q" id="kw" rel="kw" size="42" maxlength="90"> 
<input type="hidden" name="module" value="<?php echo $this->_tpl_vars['module']; ?>
"> <span class="btn_wr"><input type="submit" onmouseout="this.className='btn'" onmousedown="this.className='btn btn_h'" class="btn" id="su" value="<?php echo $this->_tpl_vars['_search_now']; ?>
"></span></form></div>
</div>
