...
";
	...
	function getByZone($zone_id, $order = "Ads.display_order", $limit=100) {
		...
		$result = $this->findAll("c.shop_name,c.picture,s.name as size_name,s.width as size_width,s.height as size_height,Ads.*", $joins, array("Ads.adzone_id=".$zone_id,"Ads.status=1","Ads.state=1"), $order, 0, $limit);
