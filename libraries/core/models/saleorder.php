<?php
class Saleorders extends PbModel {
 	var $name = "Saleorder";
 	var $info;
 	var $fields = "so.id";
 	var $amount;
	...
	function Add($params)
	{
		...
		$last_orderid = $this->$key;
		
		$result = $this->$key;
		
		//echo "1111";
		//var_dump(Tradefields::getInstance());
		//$db_saleorderitem = & Tradefields::getInstance();
		//echo $last_orderid;
		//$db_cartitem = & Cartitems::getInstance();
		//echo $last_orderid;
		//
		//var_dump($db_cartitem->getDataByMemberID($session_cart_id, $_GET["id"]));
