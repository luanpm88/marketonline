...
jQuery('#show-social').click(function() {
    ...
    if(visible){
        jQuery(this).find('span').html(jQuery(this).data("expand"));
        soc_icons.animate({width:0},'slow');
    } else {
        jQuery(this).find('span').html(jQuery(this).data("close"));
...
jQuery('.tiled-menu li').hover(function(){
        ...
        jQuery('#show-social').find('span').html(jQuery(this).data("expand"));
    },
    function(){
