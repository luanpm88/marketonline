...
//
//foreach($IndustryList["box2"] as $key => $item)
//{
//	$IndustryList["box2"][$key]["count"] = $industry->countProduct($item["id"], $pb_userinfo["pb_userid"]);
//}
//
//foreach($IndustryList["box3"] as $key => $item)
//{
//	$IndustryList["box3"][$key]["count"] = $industry->countProduct($item["id"], $pb_userinfo["pb_userid"]);
//}
//
//foreach($IndustryList["box4"] as $key => $item)
//{
//	$IndustryList["box4"][$key]["count"] = $industry->countProduct($item["id"], $pb_userinfo["pb_userid"]);
//}
