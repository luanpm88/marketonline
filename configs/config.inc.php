 ...
 */
$admin_email = 'luanpm@live.com';
$administrator_id = '1';

/**
 * domain and url config
 */
$absolute_uri = 'http://localhost/marketonline/';
...
$rewrite_able = 1;			// 是否支持网址静态化
$rewrite_compatible = 1;                // 是否支持URL中的中文字符，如果支持，则不会调用urlencode
