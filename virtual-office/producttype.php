...
//$producttype->findTreeIndustry('id,name,level', $conditions);
$result = $producttype->findAll('id,name,level',null,$conditions," id DESC");
$result = $producttype->findTree('id,name,level', $conditions);
foreach($result as $key => $item)
{
	$result[$key]["padding"] = ($item["level"]-1)*30+10;
}
